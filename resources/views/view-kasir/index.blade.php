    ...
    <div class="col-lg-6">
        <div class="row">
            <div class="card">
                ...
                data-kodepart="{{ $barangs->Kode_Part }}"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="clearBeli" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
...
function updatePesanan(id, hargaBaru) {
    ...
    if (index !== -1) {
        ...
        pesanan.push({ id, harga: hargaBaru });
    }
}
...
konfirmasiButton.addEventListener("click", () => {
    ...
    if (pelangganTetapCheckbox.checked) {
        ...
        DataPelanggan.push({ nama, noTelp });
        inputDataCustomer.value = JSON.stringify({
            Nama: nama,
