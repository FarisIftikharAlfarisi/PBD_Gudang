<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        ...
        <ul id="components-nav-karyawan" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'karyawan-index-page' ? 'active' : '' }}" href="{{ route('karyawan-index-page') }}">
                <i class="bi bi-circle"></i>
                <span>Karyawan</span>
                </a>
              </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav-penyimpanan" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Penyimpanan</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav-penyimpanan" class="nav-content collapse " data-bs-parent="#sidebar-nav">
